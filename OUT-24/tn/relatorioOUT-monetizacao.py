...
impressoes_yb_TN_2024=[26580,68705,106582,50724,49123,35649,80455,263738,343942,111380]
visuMonetizadas_yb_TN_2024=[24539,64181,99340,48892,45513,32464,77698,262329,333255,107118]
receitaBruta_yb_TN_2024=[114,313,746,274,257,202,458,1609,2077,677]
premium_yb_TN_2024=[2,4,4,3,4,2,6,13,25,7]
AdSense_yb_TN_2024=[62,138,410,151,141,111,252,885,1144,373]
...
impressoes_yb_JPN_2024=[119775,100933,152837,86663,95707,151554,161089,147669,136039,728093]
visuMonetizadas_yb_JPN_2024=[101040,83561,123957,70751,79378,120773,134537,124481,116047,616077]
receitaBruta_yb_JPN_2024=[449,354,656,388,434,657,721,674,642,2842]
premium_yb_JPN_2024=[21,28,32,28,25,28,30,36,38,131]
AdSense_yb_JPN_2024=[247,195,360,212,237,361,396,368,362,1562]

# Adiciona a seção para os resultados
with doc.create(Section('YouTube: Monetização', numbering=False)):
    with doc.create(Subsection('Outubro/2024', numbering=False)):
        with doc.create(MiniPage(align='c')):
...
doc.generate_pdf(fr'C:\Users\{GR.path_aliss}\Documents\Repositórios\Relatórios\TN\Relatório-TNeJPN_OUT_ytbMonetizacao-2024', clean_tex=True)
