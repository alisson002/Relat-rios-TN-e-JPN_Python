...
portal_usuariosUnicos_2024Table = [276184]
portal_usuariosRescorrentes_2024Table = []
portal_usuariosUnicos_2024Analytics = [213000]
portal_usuariosRescorrentes_2024Analytics = [73000]
portal_visualizacoes_2024 = [621206] # mesmo valor na tabela e no analytics
portal_novosUsuarios_2024 = [147518] # mesmo valor na tabela e no analytics

ig_seg_2024 = [1299]
ig_seg_2024_perdeu = [1040]
ig_alcance_2024 = [330170]
ig_vivitas_2024 = [24896]

#ADICIONAR TOTAL DA SEMANA SEGUINTE
ig_seg_2024_total = [532444]

fb_seg_2024 = [30]
fb_seg_2024_perdeu = [34]
fb_alcance_2024 = [64958]
fb_vivitas_2024 = [6500]

#ADICIONAR TOTAL DA SEMANA SEGUINTE
fb_seg_2024_total = [332419]

tw_seg_2024 = [359]
tw_impressões_2024 = [86012]
tw_engajamentos_2024 = [2390]

#ADICIONAR TOTAL DA SEMANA SEGUINTE
tw_seg_2024_total = [312146]
...
yb_visualizacoes_2024 = [134255]
yb_horas_2024 = [1785]

#ADICIONAR TOTAL DA SEMANA SEGUINTE
yb_inc_2024_total = [35940]

# Adiciona a seção para os resultados
with doc.create(Section('Tribuna do Norte', numbering=False)):
    with doc.create(Subsection('31/03/2024 a 06/04/2024', numbering=False)):
        with doc.create(MiniPage(align='c')):
