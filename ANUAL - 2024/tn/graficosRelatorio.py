...
def visualizacoesUsuarios():
    ...
    plt.title("Comparativo de visualizações e dados de usuários ao longo do mês")
...
def novosUsu(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/novosUsu.png"
    gerar_grafico_comparativo(
        lista_2023, lista_2024,
        titulo='Comparativo Mensal de Novos Usuários no Portal',
        ylabel='',
...
def visualizacoes(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/visualizacoes.png"
    gerar_grafico_comparativo(
        lista_2023, lista_2024,
        titulo='Comparativo Mensal de Visualizações no Portal',
        ylabel='',
        caminho_salvamento=caminho_salvamento,
        cor_2023='#A1BF75',
        cor_2024='#F77B00'
...
def usuRecorrentes(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/usuRecorrentes.png"
    gerar_grafico_comparativo(
        lista_2023, lista_2024,
        titulo='Comparativo Mensal de Usuários Recorrentes no Portal',
        ylabel='',
        caminho_salvamento=caminho_salvamento,
        cor_2023='#3C5927',
        cor_2024='#F77B00'
...
def usuUnicos(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/usuUnicos.png"
    gerar_grafico_comparativo(
        lista_2023, lista_2024,
        titulo='Comparativo Mensal de Usuários Únicos no Portal',
        ylabel='',
        caminho_salvamento=caminho_salvamento,
        cor_2023='#F25C05',
        cor_2024='#F77B00'
...
# Funções específicas para cada gráfico do Instagram
def novosUsu_ANUAL(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/novosUsu_ANUAL.png"
    gerar_grafico_comparativo_ANUAL(
        lista_2023, lista_2024,
        titulo='Comparativo Anual de Novos Usuários no Portal',
        ylabel='',
        caminho_salvamento=caminho_salvamento,
        cor_2023='#59551D',
        cor_2024='#F77B00'
...
def visualizacoes_ANUAL(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/visualizacoes_ANUAL.png"
    gerar_grafico_comparativo_ANUAL(
        lista_2023, lista_2024,
        titulo='Comparativo Anual de Visualizações no Portal',
        ylabel='',
        caminho_salvamento=caminho_salvamento,
        cor_2023='#A1BF75',
        cor_2024='#F77B00'
...
def usuRecorrentes_ANUAL(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/usuRecorrentes_ANUAL.png"
    gerar_grafico_comparativo_ANUAL(
        lista_2023, lista_2024,
        titulo='Comparativo Anual de Usuários Recorrentes no Portal',
        ylabel='',
        caminho_salvamento=caminho_salvamento,
        cor_2023='#3C5927',
        cor_2024='#F77B00'
...
def usuUnicos_ANUAL(lista_2023, lista_2024):
    caminho_salvamento = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/usuUnicos_ANUAL.png"
    gerar_grafico_comparativo_ANUAL(
        lista_2023, lista_2024,
        titulo='Comparativo Anual de Usuários Únicos no Portal',
        ylabel='',
        caminho_salvamento=caminho_salvamento,
        cor_2023='#F25C05',
        cor_2024='#F77B00'
...
def grafico_de_rosca(percent1, percent2, labels=('Feminino', 'Masculino'), titulo='Gênero dos usuários do portal'):
    """
    Gera um gráfico de rosca (donut chart) baseado em duas porcentagens.

    Args:
        percent1 (float): Primeira porcentagem.
        percent2 (float): Segunda porcentagem.
        labels (tuple): Rótulos das categorias (default=('Categoria 1', 'Categoria 2')).
        titulo (str): Título do gráfico (default='Gráfico de Rosca').
    
    Raises:
        ValueError: Se as porcentagens não somarem 100%.
    """
    # Verifica se as porcentagens somam 100%
    if percent1 + percent2 != 100:
        raise ValueError("As porcentagens devem somar 100%.")
    ...
    sexoIG_plot_path = fr"C:/Users/{path_Usuarios}/Documents/Repositórios/Imagens/TN/sexo.png"
