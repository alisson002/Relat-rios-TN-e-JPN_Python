...
portal_usuariosUnicos_2024Table = [1633738,1440822,1360093,1686858,1523523,1409476,1753667,1898844,1370851,1902909,1451975]
portal_usuariosRescorrentes_2024Table = [723672,551399,610932,713143,695163,628876,647637,704678,612918,789103,596089]

portal_usuariosUnicos_2024Analytics = [1100000,970000,872000,1100000,985000,936000,1300000,1400000,926000,1300000,1000000]
portal_usuariosRescorrentes_2024Analytics = [279000,248000,233000,267000,263000,244000,265000,306000,251000,341000,235000]

portal_visualizacoes_2024 = [3503660,2645684,3109309,3569089,3274745,3006463,3524319,3505334,2813497,3824026,2889428] # mesmo valor na tabela e no analytics
portal_novosUsuarios_2024 = [819084,778346,726313,910001,812300,764468,1101211,1194579,759312,1119030,854130] # mesmo valor na tabela e no analytics
...
ig_seg_2024 = [6931,5816,5835,7843,6717,5573,5369,6072,5521,6905,6104]
ig_seg_2024_perdeu = [5485,4945,4587,4885,4649,4326,4987,6082,4603,7306,4592]
ig_alcance_2024 = [542064,658917,633648,847362,941640,930258,1008296,1158467,922259,1345111,1125447]
ig_vivitas_2024 = [151885,144742,131296,162036,133497,117925,110346,135437,109653,202369,142333]

ig_seg_2024_total = [529865,530797,532444,535373,537733,538756,539028,538982,539983,539659,541103]
...
fb_seg_2024 = [628,389,188,295,254,251,265,516,230,253,151]
fb_seg_2024_perdeu = [162,162,176,171,158,132,160,213,203,295,184]
fb_alcance_2024 = [467889,390008,197628,292192,257199,254134,266380,675762,205619,222416,163290]
fb_vivitas_2024 = [32152,31459,31499,31612,29294,22864,24050,26171,21062,26441,22817]

fb_seg_2024_total = [332603,332614,332419,332336,332214,332133,332006,332122,331921,331641,331426]
...
yb_inc_2024 = [415,614,1506,1235,536,439,684,1690,1724,573,384]
yb_inc_2024_perdeu = [85,84,110,97,83,76,100,142,172,111,72]
yb_visualizacoes_2024 = [132377,137318,371375,339297,139698,94934,175389,431106,657651,201390,129201]
yb_horas_2024 = [2339,4194,5135,5316,3288,2302,2724,5438,9389,2692,1633]

yb_inc_2024_total = [34000,34500,35940,37092,37544,37922,38507,40032,41578,42052,42354]

# Adiciona a seção para os resultados
with doc.create(Section('Tribuna do Norte', numbering=False)):
    with doc.create(Subsection('Resultados de novembro/2024', numbering=False)):
        with doc.create(MiniPage(align='c')):
        ...
        with doc.create(Itemize()) as itemize:
            ...
            with itemize.create(Enumerate(enumeration_symbol=r"-")) as sublist:
                ...
                # sublist.add_item(f"Obs.: O número de seguidores do Facebook voltou a subir no mês de agosto.")
    ...
    with doc.create(Subsubsection('Portal', numbering=False)):
        with doc.create(MiniPage(align='c')):
            ...
            with doc.create(Tabular('|c|c|c|c|', booktabs =True)) as table:
                ...
                table.add_hline()
                table.add_row((MultiRow(2, data='Agosto'), GR.numeroPorExtensso(portal_novosUsuarios_2024[7]), GR.numeroPorExtensso(portal_visualizacoes_2024[7]), GR.numeroPorExtensso(portal_usuariosRescorrentes_2024Analytics[7])))
...
with doc.create(Enumerate(enumeration_symbol=r"•")) as itemize:     
    ...
    with itemize.create(Enumerate(enumeration_symbol=r"-")) as sublist:
        ...
        sublist.add_item(NoEscape(r"Apesar de ter o maior crecimento percentual nas visualizações, \textbf{março} não é o melhor mês como foi em foi 2023. Além disso, tem os menores números de novos usuários e recorrentes até o momento."))
        sublist.add_item(NoEscape(r"\textbf{Agosto} é o segundo melhor mês até o momento."))
...
with doc.create(Enumerate(enumeration_symbol=r"•")) as itemize:     
    ...
    with itemize.create(Enumerate(enumeration_symbol=r"-")) as sublist:
        ...
        sublist.add_item(NoEscape(r"\textbf{Outubro} foi o melhor mês em \textbf{alcance e visitas}."))
        ...
        sublist.add_item(NoEscape(r"\textbf{Novembro} tem números semelhantes aos de \textbf{agosto}."))
    ...
    with doc.create(Subsubsection('Facebook', numbering=False)):
        with doc.create(MiniPage(align='c')):
            ...
            with doc.create(Tabular('|c|c|c|c|', booktabs =True)) as table:
                ...
                table.add_row(('', FootnoteText(f'{GR.crescimento(fb_seg_2024[4],fb_seg_2024[3])} | {GR.crescimento(fb_seg_2024[4],fb_seg_2023[4])}'), FootnoteText(f'{GR.crescimento(fb_alcance_2024[4],fb_alcance_2024[3])} | {GR.crescimento(fb_alcance_2024[4],fb_alcance_2023[4])}'), FootnoteText(f'{GR.crescimento(fb_vivitas_2024[4],fb_vivitas_2024[3])} | {GR.crescimento(fb_vivitas_2024[4],fb_vivitas_2023[4])}')))
                table.add_hline()
                ...
                table.add_row(('', FootnoteText(f'{GR.crescimento(fb_seg_2024[5],fb_seg_2024[4])} | {GR.crescimento(fb_seg_2024[5],fb_seg_2023[5])}'), FootnoteText(f'{GR.crescimento(fb_alcance_2024[5],fb_alcance_2024[4])} | {GR.crescimento(fb_alcance_2024[5],fb_alcance_2023[5])}'), FootnoteText(f'{GR.crescimento(fb_vivitas_2024[5],fb_vivitas_2024[4])} | {GR.crescimento(fb_vivitas_2024[5],fb_vivitas_2023[5])}')))
                table.add_hline()
                ...
                table.add_row(('', FootnoteText(f'{GR.crescimento(fb_seg_2024[8],fb_seg_2024[7])} | {GR.crescimento(fb_seg_2024[8],fb_seg_2023[8])}'), FootnoteText(f'{GR.crescimento(fb_alcance_2024[8],fb_alcance_2024[7])} | {GR.crescimento(fb_alcance_2024[8],fb_alcance_2023[8])}'), FootnoteText(f'{GR.crescimento(fb_vivitas_2024[8],fb_vivitas_2024[7])} | {GR.crescimento(fb_vivitas_2024[8],fb_vivitas_2023[8])}')))
                table.add_hline()
                ...
                table.add_row(('', FootnoteText(f'{GR.crescimento(fb_seg_2024[9],fb_seg_2024[8])} | {GR.crescimento(fb_seg_2024[9],fb_seg_2023[9])}'), FootnoteText(f'{GR.crescimento(fb_alcance_2024[9],fb_alcance_2024[8])} | {GR.crescimento(fb_alcance_2024[9],fb_alcance_2023[9])}'), FootnoteText(f'{GR.crescimento(fb_vivitas_2024[9],fb_vivitas_2024[8])} | {GR.crescimento(fb_vivitas_2024[9],fb_vivitas_2023[9])}')))
                table.add_hline()
                ...
                # table.add_row(('', FootnoteText(f'{GR.crescimento(fb_seg_2024[11],fb_seg_2024[10])} | {GR.crescimento(fb_seg_2024[11],fb_seg_2023[11])}'), FootnoteText(f'{GR.crescimento(fb_alcance_2024[11],fb_alcance_2024[10])} | {GR.crescimento(fb_alcance_2024[11],fb_alcance_2023[11])}'), FootnoteText(f'{GR.crescimento(fb_vivitas_2024[11],fb_vivitas_2024[10])} | {GR.crescimento(fb_vivitas_2024[11],fb_vivitas_2023[11])}')))
...
with doc.create(Enumerate(enumeration_symbol=r"•")) as itemize:     
    ...
    with itemize.create(Enumerate(enumeration_symbol=r"-")) as sublist:
        ...
        sublist.add_item(NoEscape(r"\textbf{Setembro} está entre os meses com os menores números em todas as métricas, ficando acima apenas de \textbf{março} em \textbf{novos seguidores e alcance}."))
        sublist.add_item(NoEscape(r"\textbf{Novembro} tem números mais baixos em \textbf{novos seguidores e alcance} até o momento. Em \textbf{visitas} só não tem números mais baixos do que \textbf{setembro}."))
...
#                 table.add_hline()
#                 table.add_row((MultiRow(2, data='Julho'), '-', '-', '-'))
#                 table.add_row(('', FootnoteText('- | -'), FootnoteText('- | -'), FootnoteText('- | -')))
#                 # table.add_hline()
#                 # table.add_hline()
...
with doc.create(Enumerate(enumeration_symbol=r"•")) as itemize:     
    itemize.add_item("Mês anterior:")
    with itemize.create(Enumerate(enumeration_symbol=r"-")) as sublist:
        sublist.add_item(NoEscape(r"\textbf{Agosto} foi o 2º melhor mês até o momento. \textbf{Março} vem em seguida e ambos possuem bons crecimentos percentuais."))
        sublist.add_item(NoEscape(r"\textbf{Abril} foi o primeiro mês com quedas após uma sequência de crescimento."))
        sublist.add_item(NoEscape(r"De \textbf{abril} a \textbf{junho} as métricas pararam de crescer. A partir de \textbf{julho} as métricas continuaram crescendo até \textbf{setembro}, o que nos mostra um certo pradrão com 3 meses crescendo, seguidos de 3 meses de queda e mais 3 messes de crescimento em sequência."))
        sublist.add_item(NoEscape(r"\textbf{Setembro} é o melhor mês até o momento."))
        sublist.add_item(NoEscape(r"\textbf{Outubro} quabra a sequência de crescimento iniciada em \textbf{julho}."))
...
doc.generate_pdf(fr'C:\Users\{GR.path_aliss}\Documents\Repositórios\Relatórios\TN\Relatório-TN_NOV-2024', clean_tex=True)
